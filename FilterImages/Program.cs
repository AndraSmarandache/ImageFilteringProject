...
class Program
{
    ...
    static void Main()
    {
        ...
        string inputImagePath = Path.Combine(imagesDir, "resized_image_32768x32768.jpg");
        string outputImagePath = Path.Combine(imagesDir, "filtered_image_32768x32768.jpg");
        int radius = 30;
